...
const menuGroups = [
  {
    ...
    menuItems: [
     ...
     
      {
        ...
        route: "#",
        children: [
          { label: "VIB", route: "/tables" , },
          { label: "NIB", route: "/tables" , },
          { label: "NYB", route: "/tables" , },
          { label: "KAB", route: "/tables" , },
        ],
      },
      {
        icon: (
  ...
  },
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Parking Management", route: "/ui-elements/alerts" },
          { label: "Facial Recognition", route: "/ui-elements/buttons" },
        ],
      },
      {
        icon: (
